...
def test_corner_cases_issue_299():
    assert countrycode("Trinidad and Tobago", "country.name", "un.name.es") == "Trinidad y Tabago"
...
def test_corner_cases_viet_nam_variations():
    ...
    assert countrycode("Democratic Republic of VietNam", "country.name", "cowc") == "DRV"
    assert countrycode("Democratic Republic of Viet Nam", "country.name", "cowc") == "DRV"
